...
export const zh: Record<DictKey, string> = {
  ...
  "sidebar.navigation": "MicroRealm Lab 导航",
  "sidebar.plugins": "插件",
  ...
  "topicBar.more": "更多",
  "topicBar.command": "命令",
  "topicBar.studentMode": "学生版",
  "topicBar.studentModeOn": "学生版已开",
  "topicBar.studentModeSyncFailed": "学生版还没切换成功，稍后再试一次",
  ...
  "caps.reportedReadOnlyTitle": "此 MCP 服务器声明了 readOnlyHint；RealmLab 会在规划需要时询问一次，也可在这里预先信任",
  ...
  "welcome.studentEx1": "做一个会下雪的个人主页",
  "welcome.studentEx2": "写一个猜数字的小游戏",
  "welcome.studentEx3": "用代码画一棵樱花树",
  "welcome.studentEx4": "把我的点子做成一个小网站",
  ...
  "composer.accessMenuTitle": "工具权限（Ctrl/Cmd+Y 切换 Soha）",
  ...
  "composer.accessYolo": "Soha批准",
  "composer.accessYoloTitle": "Soha批准（梭哈，Ctrl/Cmd+Y）会跳过所有工具权限审批",
  ...
  "composer.modeTitle": "工具权限菜单；shift+tab 只切计划模式；ctrl/cmd+y 切换 Soha",
  ...
  "heartbeat.noTasks": "暂无心跳任务。点击「添加任务」创建一个。\n\n提示：AI 代理也可直接编辑 MicroRealm Lab 用户状态目录中的 heartbeat-tasks.json。",
  "heartbeat.every": "每",
  ...
  "heartbeat.configHint": "AI 代理也可直接编辑 MicroRealm Lab 用户状态目录中的 heartbeat-tasks.json。",
  ...
  "status.yolo": "Soha",
  "status.yoloTitle": "Soha —— 正在跳过工具批准；ask 与计划确认仍会等待",
  ...
  "memory.emptySavedBody": "只保存对后续 MicroRealm Lab 会话有帮助的长期背景。",
  ...
  // 设置抽屉
  "settings.title": "设置",
  "settings.studentModeTitle": "调一调",
  "settings.studentModelTab.usage": "我在用",
  "settings.studentModelTab.access": "去添加",
  ...
  "settings.closeBehavior.quit": "退出 MicroRealm Lab",
  ...
  "settings.defaultToolApprovalModeHint": "保存在全局设置中，仅用于新建会话；切换或恢复已有会话时不会覆盖其 Ask / Auto / Soha 状态。",
  ...
  "settings.agentRuntimeHint": "轮数上限只认全局设置；项目配置不会覆盖。0 表示不限。",
  ...
  "settings.botInstallSubtitle": "连接完成后即可在聊天里调用 MicroRealm Lab。",
  ...
  "settings.botInstallManualQQ": "填写 App ID 和 App Secret；密钥只保存到 MicroRealm Lab 全局 .env。",
  ...
  "settings.yolo": "Soha —— 跳过工具批准（仅本会话）",
  "settings.yoloHint": "Soha批准会跳过所有工具权限审批（写文件、bash）。deny 规则仍会拦截，ask 问题和计划确认仍会等待你选择。仅运行时生效，重启后失效。",
  ...
  "shortcuts.action.yoloToggle": "切换 Soha 审批",
  ...
  "shortcuts.desc.yoloToggle": "在输入时切换 Soha 工具审批模式。",
  ...
  "settings.pageDesc.memory": "管理 MicroRealm Lab 会长期参考的偏好、项目约定和指令文件。",
  ...
  "settings.studentPage.models": "选 AI",
  "settings.studentPage.skills": "加本领",
  "settings.studentSection.currentModel": "现在用哪个 AI",
  "settings.studentField.currentModel": "聊天 AI",
  ...
  "settings.addProvider.officialChoiceHint": "从 MicroRealm Lab 预设的 DeepSeek 接入中选择。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。重启 MicroRealm Lab 后加载新的 hooks。",
  "settings.hooksProjectHint": "保存在当前工作区。项目 hooks 需要信任，并在重启 MicroRealm Lab 后加载。",
  ...
  "settings.config": "全局配置文件：RealmLab 本地配置已加载",
  "settings.configHint": "内部会保留旧版配置路径用于兼容；正常使用无需处理。",
  ...
  "updater.autoCheckHint": "关闭后，MicroRealm Lab 打开时不会自动检查更新；你仍可在此页手动检查。",
  ...
  "onboarding.title": "连接 MicroRealm Lab",
  "onboarding.tagline": "粘贴一个 DeepSeek API key 即可开始。密钥仅保存到 MicroRealm Lab 全局 .env，仅用于 provider 请求。",
  ...
  "onboarding.privacy": "仅保存在 MicroRealm Lab 全局 .env",
  ...
  // 崩溃兜底页
  "crash.title": "MicroRealm Lab 遇到错误 —— 可以一键发送报告，或复制后反馈",
  "crash.copy": "复制",
  "crash.send": "发送报告",
  "crash.sending": "发送中…",
  "crash.sent": "已发送，谢谢！",
  ...
  "performanceReport.title": "MicroRealm Lab 检测到响应卡顿",
  ...
  "mock.topicSysCoord": "01 示例服务项目总协调",
  ...
  "mock.askQ2Header": "MicroRealm Lab 构建",
  "mock.askQ2Prompt": "对于 RealmLab 二进制缺失的问题，你想怎么做？",
