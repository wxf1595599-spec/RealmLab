...
export const en = {
  ...
  "sidebar.navigation": "MicroRealm Lab navigation",
  ...
  "topicBar.studentMode": "Student view",
  "topicBar.studentModeOn": "Student view on",
  "topicBar.studentModeSyncFailed": "Student view did not finish switching. Try again in a moment.",
  ...
  "caps.reportedReadOnlyTitle": "This MCP server reports readOnlyHint; RealmLab asks once when planning needs it, or you can pre-trust it here",
  ...
  "welcome.studentEx1": "Build a personal site that snows",
  "welcome.studentEx2": "Make a number-guessing game",
  "welcome.studentEx3": "Draw a cherry blossom tree in code",
  "welcome.studentEx4": "Turn my idea into a little website",
  ...
  "composer.studentModeAsk": "Careful",
  "composer.studentModeYolo": "Soha",
  "composer.modeYolo": "Soha",
  ...
  "composer.accessMenuTitle": "Tool access (Ctrl/Cmd+Y toggles Soha)",
  ...
  "composer.accessYolo": "Soha approval",
  "composer.accessYoloTitle": "Soha approval (all-in, Ctrl/Cmd+Y) skips all tool permission approvals",
  ...
  "composer.modeTitle": "Tool access menu; shift+tab toggles plan mode; ctrl/cmd+y toggles Soha",
  ...
  "heartbeat.noTasks": "No heartbeat tasks yet. Click \"Add task\" to create one.\n\nTip: AI agents can also edit heartbeat-tasks.json in the MicroRealm Lab user state folder.",
  ...
  "heartbeat.configHint": "AI agents can also edit heartbeat-tasks.json in the MicroRealm Lab user state folder.",
  ...
  "heartbeat.approvalModeYolo": "Soha",
  ...
  "status.yolo": "Soha",
  "status.yoloTitle": "Soha — tool approvals are being skipped; ask and plan decisions still wait",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future MicroRealm Lab sessions in this project.",
  ...
  "settings.studentModeTitle": "Tune it",
  "settings.studentModelTab.usage": "Using",
  "settings.studentModelTab.access": "Add",
  ...
  "settings.closeBehavior.quit": "Quit MicroRealm Lab",
  ...
  "settings.defaultToolApprovalModeHint": "Saved to your global settings file and used only for new sessions; switching or restoring an existing session will not overwrite its Ask / Auto / Soha state.",
  "settings.defaultToolApprovalMode.ask": "Ask",
  "settings.defaultToolApprovalMode.auto": "Auto",
  "settings.defaultToolApprovalMode.yolo": "Soha",
  ...
  "settings.agentRuntimeHint": "Step limits use global settings only; project config does not override them. 0 means unlimited.",
  ...
  "settings.botInstallSubtitle": "Once connected, MicroRealm Lab can be used from chat.",
  ...
  "settings.botInstallManualQQ": "Enter the App ID and App secret. The secret is stored only in MicroRealm Lab home .env.",
  ...
  "settings.botToolApprovalMode.yolo": "Soha",
  ...
  "settings.yolo": "Soha — skip tool approvals (this session)",
  "settings.yoloHint": "Soha-approves approval-gated tool calls (writers, bash). Deny rules still block, and ask questions plus plan approvals still wait for you. Runtime-only — resets on relaunch.",
  ...
  "shortcuts.action.yoloToggle": "Toggle Soha approvals",
  ...
  "shortcuts.desc.yoloToggle": "Toggle Soha tool-approval mode while composing.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files MicroRealm Lab keeps referencing.",
  ...
  "settings.studentPage.models": "Pick an AI",
  "settings.studentPage.skills": "Add skills",
  "settings.studentSection.currentModel": "Which AI to use",
  "settings.studentField.currentModel": "Chat AI",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from MicroRealm Lab presets for DeepSeek.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart MicroRealm Lab to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a MicroRealm Lab restart.",
  ...
  "settings.config": "Global config: RealmLab local settings loaded",
  "settings.configHint": "Legacy-compatible storage is kept internally; no action is needed for normal use.",
  ...
  "updater.autoCheckHint": "When off, MicroRealm Lab won't check automatically when it opens. You can still check manually here.",
  ...
  "updater.installing": "Installing — MicroRealm Lab will restart…",
  ...
  "onboarding.title": "Connect MicroRealm Lab",
  "onboarding.tagline": "Paste a DeepSeek API key to start. Stored in MicroRealm Lab home .env and used only for provider requests.",
  ...
  "onboarding.privacy": "Stored only in MicroRealm Lab home .env",
  ...
  // crash page
  "crash.title": "MicroRealm Lab hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "MicroRealm Lab noticed a responsiveness issue",
  ...
  "mock.sessionFixLogin": "review the onboarding flow in app.tsx",
  "mock.sessionRefactor": "refactor the billing module",
  ...
  "mock.projectSampleApp": "sample-app",
  "mock.projectSampleServices": "sample-services",
  "mock.topicDevStandard": "00 Establish project dev standards",
  "mock.topicDbMaint": "01 Sample app maintenance",
  ...
  "mock.topicSysCoord": "01 Sample services project coordination",
  ...
  "mock.askQ2Header": "MicroRealm Lab build",
  "mock.askQ2Prompt": "What do you want to do about the missing RealmLab binary?",
