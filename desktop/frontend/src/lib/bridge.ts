...
function makeMockApp(): AppBindings {
  ...
  const capSkills: SkillView[] = [
    ...
    { name: "init", description: "Scaffold an AGENTS.md for this repo", scope: "builtin", runAs: "inline", enabled: true },
  ];
  let capSkillRoots: SkillRootView[] = [
    { dir: "~/projects/realmlab/.reasonix/skills", scope: "project", priority: 1, status: "missing", configured: false, removable: true, skills: 0 },
    {
      dir: "~/.reasonix/skills",
      scope: "global",
      priority: 5,
      ...
      skillItems: [
        ...
        { name: "init", description: "Scaffold an AGENTS.md for this repo", scope: "global", runAs: "inline" },
      ],
    },
  ];
  ...
  const settings: SettingsView = {
    ...
    autoPlan: "off",
    providers: [
      { name: "deepseek", builtIn: true, added: false, kind: "openai", baseUrl: "https://api.deepseek.com", modelsUrl: "", models: ["deepseek-v4-flash"], visionModels: [], visionModelsConfigured: false, default: "deepseek-v4-flash", apiKeyEnv: "DEEPSEEK_API_KEY", keySet: false, balanceUrl: "https://api.deepseek.com/user/balance", contextWindow: 1_000_000, reasoningProtocol: "", supportedEfforts: [], defaultEffort: "" },
    ],
    officialProviders: [
      { name: "deepseek", builtIn: true, added: false, kind: "openai", baseUrl: "https://api.deepseek.com", modelsUrl: "", models: ["deepseek-v4-flash", "deepseek-v4-pro"], visionModels: [], visionModelsConfigured: false, default: "deepseek-v4-flash", apiKeyEnv: "DEEPSEEK_API_KEY", keySet: false, balanceUrl: "https://api.deepseek.com/user/balance", contextWindow: 1_000_000, reasoningProtocol: "", supportedEfforts: [], defaultEffort: "" },
    ],
    ...
    configPath: "~/projects/realmlab/project-config.toml",
  ...
  return {
    ...
    async PickWorkspace() {
      ...
      return mockSwitchWorkspace(cwd.endsWith("another-project") ? "~/projects/realmlab" : "~/projects/another-project");
    },
      ...
      settings.permissions[k] = settings.permissions[k].filter((r) => r !== rule);
        ...
        async StartBotConnectionInstall(provider: string, domain: string) {
          ...
          return {
            ...
            url: "https://example.com/realmlab-bot-qr",
    ...
    async DownloadUpdate() {
      ...
      return { version: "v1.1.0", channel: "stable", path: "/tmp/realmlab-update", size: total, sha256: "mock" };
    },
    async InstallUpdate() {
      const total = 12_345_678;
    ...
    async OpenDownloadPage() {
      if (typeof window !== "undefined") {
        window.open("https://github.com/wxf1595599-spec/RealmLab/releases/latest", "_blank", "noopener");
      }
    },
